              ...
              <Grid container>
                <Grid md={5} xs={12}>
                  <div className={`img ${imageLoad ? "active" : ""}`}>
                    <div className="img-lazy">
                      <img alt="me" src={require("images/me.jpg?lqip")} />
                    </div>
                    <img
                      className={"img-real"}
                ...
                <Grid xs={12} className="services-container">
                  <Title align={"center"} variant={"h2"}>
                    {t({ id: "my" })}{" "}
                    <span className="word2">{t({ id: "services" })}</span>
                  </Title>
                  <div className="services">
                    <div className="item">
                      <AiOutlineDesktop />
                      <Typography align={"center"} variant={"subtitle1"}>
                        {t({ id: "web development" })}{" "}
                      </Typography>
                      <Typography variant={"body2"}>
                        {" "}
                        {t({ id: "web development.description" })}
                      </Typography>
                    </div>
                    ...
                    <div className="item">
                      ...
                      <Typography variant={"body2"}>
                        {t({ id: "fast delivery.description" })}{" "}
                      </Typography>
                    </div>
                    <div className="item">
                      <AiOutlineMobile />
                      <Typography align={"center"} variant={"subtitle1"}>
                        {" "}
                        {t({ id: "app development" })}{" "}
                      </Typography>
                      <Typography variant={"body2"}>
                        {" "}
                        {t({ id: "app development.description" })}{" "}
                      </Typography>
                    </div>
                  </div>
                </Grid>
